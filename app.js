...
document.addEventListener('DOMContentLoaded', async () => {
    const priceMap = {
        ...
        'PE': { orig: '39.00', curr: 'PEN', pre: '~ S/ ', link: 'https://pay.hotmart.com/X105956920F?off=mafu74sa&checkoutMode=10' },
        'AR': { orig: '16.500', curr: 'ARS', pre: '~ $', link: 'https://pay.hotmart.com/X105956920F?off=0xalz286&checkoutMode=10' },
